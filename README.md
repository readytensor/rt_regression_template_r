...
- Run the script `src/train.r` to train the linear regression model. This will save the model artifacts, including the preprocessing pipeline, in the path `./model_inputs_outputs/model/artifacts/`.
